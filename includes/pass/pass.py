...
lport = 4443
targets = []
activitylog = "/pineapple/components/infusions/portalauth/includes/pass/pass.log"
targetlog = "/pineapple/components/infusions/portalauth/includes/pass/targets.log"
